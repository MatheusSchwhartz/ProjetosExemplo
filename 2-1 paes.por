programa
{
	...
	inteiro paesUn, broasUn
	const real paoFrances = 0.50
	const real broa = 5.00
	real valorArrecadado, poupar
	...
	valorArrecadado = (paesUn * paoFrances) + (broasUn * broa)

	poupar = valorArrecadado * 0.10

	escreva("Total de Pães e broas vendidas: ", valorArrecadado, "\n")
	escreva("poupar:R$", poupar, "\n")
